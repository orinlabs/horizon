...
THREADS = [
    {
        ...
        "messages": [
            {
                "from": "Nia Patel",
                "sent_at": "2026-05-03T12:45:00Z",
                "body": "For today's reading group prep, which paper should I prioritize and how should I format the prep notes?",
            }
        ],
    },
    {
        "thread_id": "inbox-omar-reading",
        "sender": "Omar Saleh",
        "unread": False,
        "messages": [
            {
                "from": "Omar Saleh",
                "sent_at": "2026-05-02T17:30:00Z",
                "body": "The database group is starting with Vector Clocks in Practice and wants long-form notes.",
            }
        ],
    },
]
