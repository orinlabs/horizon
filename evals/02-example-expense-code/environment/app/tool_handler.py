...
THREADS = [
    {
        ...
        "messages": [
            {
                "from": "Casey Morgan",
                "sent_at": "2026-05-02T09:12:00Z",
                "body": "I'm filing the Bay trip reimbursement. What project code should I use, and is there anything special I should attach?",
            }
        ],
    },
    {
        "thread_id": "inbox-riley-onboarding",
        "sender": "Riley Chen",
        "unread": False,
        "messages": [
            {
                "from": "Riley Chen",
                "sent_at": "2026-05-01T15:40:00Z",
                "body": "For onboarding lunches, use project code LUNCH-11. This is unrelated to travel reimbursements.",
            }
        ],
    },
]
